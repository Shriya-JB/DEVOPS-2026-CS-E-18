...
def get_repo_info():
    ...
    try:
        ...
        # -----------------------------------------------------
        # If that fails, try remote origin URL
        # -----------------------------------------------------
...
def get_git_metrics(interval="weekly"):
    ...
    # ---------------------------------------------------------
        ...
        print(
            "Use: daily, weekly, monthly, or final"
        )
...
def create_charts(
    ...
    """
    Generates workload distribution and timeline comparison
    charts.
    """
...
def generate_pdf(interval="weekly"):
    ...
    result = get_git_metrics(interval)
    ...
    if interval == "daily":
        ...
        doc_name = (
            f"{repo_name}_Daily_"
            f"Progress_Report_{date_stamp}.pdf"
        )
        ...
        doc_name = (
            f"{repo_name}_Weekly_"
            f"Progress_Report_Form-3_{date_stamp}.pdf"
        )
